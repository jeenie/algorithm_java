...
public class Example4 {
	...
	/*
	 * static int search3(int[] a, int value, int start, int end) { if(start < end)
	 * return -1; //종료조건 int middle = (start + end) / 2; if(a[middle] > value)
	 * return search3(a, value, start, middle - 1); else if (a[middle] < value)
	 * return search3(a, value, middle + 1, end); return middle; }
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(a)); // 정렬 전 배열
		sort(a);
		System.out.println(Arrays.toString(a)); // 정렬 후 배열
